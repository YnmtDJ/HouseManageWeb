...
@WebServlet("/PostSecServlet")
public class PostSecServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
        ...
        try {
            ...
            for(FileItem item:items){
                ...
                if(item.isFormField()){
                    ...
                    switch (fieldName) {
                        ...
                        case "S_price" -> S_price=Integer.parseInt(item.getString("UTF-8"));
            ...
            Second_House house=new Second_House(null,H_type,H_area,H_time,H_decorate,H_direct,H_rate,H_layer,C_id,inputStream,S_price);
            Connection connection= DBUtil.getConnection();
            House_Dao houseDao=new House_Dao(connection);
            //插入房源数据
            if(houseDao.InsertHouse(house,"二手房",B_id,user.U_id)){//成功
            ...
            request.getRequestDispatcher("PostSecHouse.jsp").forward(request,response);
