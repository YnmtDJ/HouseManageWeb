...
<%
    ...
    List<Double> prices=new ArrayList<>();//平均租金
...
<script type="text/javascript">
    ...
    var AddAdminOverlays = function () {
        ...
        var myOverlay = new MyOverlay(points.at(<%=i%>),"<%=adminAreas.get(i).name%>","<%=nums.get(i)%>套","<%=prices.get(i)%>元/月",
            ...
            success: function (data) {	//请求成功
                ...
                for(var i=0;i<data.length;i++){//循环遍历每个小区
                    ...
                    (function (i) {
                        ...
                        var myOverlay = new MyOverlay(center,community.C_name,community.Num+"套",community.Price+"元/月",
