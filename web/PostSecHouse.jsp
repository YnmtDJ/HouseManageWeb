...
<html>
    ...
    <body>
        ...
        <div style="text-align: center;background-color: #f3efef;padding: 20px;">
            <span style="font-size: xxx-large">发布二手房(<%=community.name%>)</span><br>
        ...
        border: 1px solid lightgrey;border-radius: 1%">
            <form method="post" action="PostSec?C_id=<%=C_id%>" enctype="multipart/form-data">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td style="height: 50px">
                            <span style="font-weight: bold">售价&nbsp;&nbsp;</span>
                            <label><input type="number" name="S_price" required="required">元/平米&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                        </td>
                        <td>
